...
exports.CuentaContableService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const cuenta_contable_entity_1 = require("./cuenta-contable.entity");
let CuentaContableService = class CuentaContableService {
    constructor(cuentaContableRepository) {
        this.cuentaContableRepository = cuentaContableRepository;
    }
    async create(cuentaContable) {
    ...
    async update(id, cuentaContable) {
...
exports.CuentaContableService = CuentaContableService;
exports.CuentaContableService = CuentaContableService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(cuenta_contable_entity_1.CuentaContable)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], CuentaContableService);
//# sourceMappingURL=cuenta-contable.service.js.map